...
import { FolderOpen, Palette, FileText, Sparkles, Trash2 } from "lucide-react";
    ...
    if (open) {
      if (isEditing) {
        setForm({
          ...
          color: editingProject.color || "indigo",
          description: editingProject.description || "",
        });
        setShowDescription(!!editingProject.description);
      } else {
        setForm(emptyForm);
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500">
                {isEditing ? "Atualize os detalhes do projeto" : "Crie um novo projeto para organizar suas tasks"}
              </p>
            </div>
          </div>
        </div>
            ...
            {!showDescription ? (
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  rows={3}
                  className="text-sm resize-none bg-gray-50 dark:bg-gray-800/60 border-gray-100 dark:border-gray-700/50 rounded-xl focus-visible:ring-0 focus-visible:border-emerald-300 dark:focus-visible:border-emerald-500/40 placeholder:text-gray-300 dark:placeholder:text-gray-600 transition-all"
                />
              </div>
            )}
          </div>
